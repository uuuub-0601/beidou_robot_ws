...
static const _ElderlyMotion_type_support_symbol_names_t _ElderlyMotion_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, beidou_interfaces, msg, ElderlyMotion)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, beidou_interfaces, msg, ElderlyMotion)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, beidou_interfaces, msg, ElderlyMotion)() {
  return &::beidou_interfaces::msg::rosidl_typesupport_c::ElderlyMotion_message_type_support_handle;
}
