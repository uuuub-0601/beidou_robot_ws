...
bool beidou_interfaces__msg__elderly_motion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("beidou_interfaces.msg._elderly_motion.ElderlyMotion", full_classname_dest, 51) == 0);
  }
  beidou_interfaces__msg__ElderlyMotion * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of ElderlyMotion */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("beidou_interfaces.msg._elderly_motion");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ElderlyMotion");
